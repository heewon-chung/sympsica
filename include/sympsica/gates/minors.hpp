...
//
//   LAYER 1 (ONE BeaverEngine::mul batch, 20 products):
...
//   LAYER 2 (ONE BeaverEngine::mul batch, 9 products):
...
//
// mu_impl = 29 secure multiplications total (20 + 9), <= paper's bound
// mu(4) <= 40; consumes exactly 29 triples and 2 communication rounds.
class MinorCircuit {
public:
    // d must have exactly 7 entries (d1..d7, C++ index 0..6). Returns
    // {D1,D2,D3,D4} as fresh Shares.
